({
    getWords : function(count) {
        ...
        let wordsArray = [
            ...
            //open=false property using JS map :App. Event 231
    ...
    getWinWord : function(arr){
        //to get random location from where we pick up our words
